...
import com.example.config.pay.AlipayConfig;
import com.example.config.pay.PayService;
import com.example.constants.Constants;
import com.example.controller.BaseController;
import com.example.domain.*;
import com.example.dto.OrderChargeDto;
import com.example.dto.OrderChargeFromDto;
import com.example.dto.OrderChargeItemDto;
import com.example.service.CareService;
import com.example.service.OrderChargeService;
...
public class OrderChargeController extends BaseController {
    ...
    public AjaxResult getNoChargeCareHistoryByRegId(@PathVariable String regId) {
        ...
        if (mapList.isEmpty()) {
            return AjaxResult.fail("【" + regId + "】的挂号单没有未支付的处方信息，请核对后再查询");
        } else {
